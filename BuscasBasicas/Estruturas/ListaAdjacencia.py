...
class ListaAdjacencia:
    ...
    def adicionaVertice(self, nome): #A
    ...
    def adicionaAresta(self, nomeV1, nomeV2, relacao, fluxo):
		#relacao é o peso das arestas
        if(nomeV2 in self.listaAdj[nomeV1]):
            return "Ja ha uma relacao entre os vertices"
        
        self.listaAdj[nomeV1].adicionaVertice(nomeV2, relacao,fluxo)
